...
//        System.setProperty("https.proxyPort", "" + 10808);
        ...
        SearchListResponse response = request.setMaxResults(50L)
                .setOrder("date")
                .setPublishedAfter(new com.google.api.client.util.DateTime(startDate, TimeZone.getDefault()))
                .setPublishedBefore(new com.google.api.client.util.DateTime(endDate, TimeZone.getDefault()))
                .execute();
