...
import org.saxing.netty.MessageType;
...
public class HeartBeatRespHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		...
		// 返回心跳应答消息
		if (message.getNettyMessageHeader() != null && message.getNettyMessageHeader().getType() == MessageType.HEARTBEAT_REQ.value()) {
	...
	private NettyMessage buildHeatBeat() {
		...
		nettyMessageHeader.setType(MessageType.HEARTBEAT_RESP.value());
