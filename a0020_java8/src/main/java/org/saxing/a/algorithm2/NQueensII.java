...
public class NQueensII {
    ...
    public static void main(String[] args) {
        ...
        int res11 = bitNQueues9(4);
        System.out.println(res11);

        int res12 = bitNQueues10(4);
        System.out.println(res12);

        int res13 = bitNQueues11(4);
        System.out.println(res13);

        int res14 = bitNQueues12(4);
...
//==================================================================================================
    ...
    public static int bitNQueues12(int n){
        if (n <= 0){
            return 0;
        }
        dfsBit12(n, 0, 0, 0, 0);
    ...
    public static void dfsBit12(int n, int row, int col, int pie, int na){
        if (row >= n){
            count12++;
            return;
        }
        ...
        while (bit > 0){
            int p = bit & -bit;
            dfsBit12(n, row + 1, col | p, (pie | p) << 1, (na | p) >> 1);
            bit &= (bit - 1);
        }
    }
...
//==================================================================================================
    ...
    public static int bitNQueues11(int n){
        if (n <= 0){
            return 0;
        }
        dfsBit11(n, 0, 0, 0, 0);
    ...
    public static void dfsBit11(int n, int row, int col, int pie, int na){
        if (row >= n){
            count11++;
            return;
        }
        ...
        while (bit > 0){
            int p = bit & -bit;
            dfsBit11(n, row + 1, col | p, (pie | p) << 1, (na | p) >> 1);
            bit &= (bit - 1);
        }
    }
...
//==================================================================================================
    ...
    public static int bitNQueues10(int n){
        if (n <= 0){
            return 0;
        }
        dfsBit10(n, 0, 0, 0, 0);
    ...
    public static void dfsBit10(int n, int row, int col, int pie, int na){
        if (row >= n){
            count10++;
            return;
        }
        ...
        while (bit > 0){
            int p = bit & -bit;
            dfsBit10(n, row + 1, col | p, (pie | p) << 1, (na | p) >> 1);
            bit &= (bit - 1);
        }
    }
...
//==================================================================================================
    ...
    static int count9 = 0;
    public static int bitNQueues9(int n){
        if (n <= 0){
            return 0;
        }
        dfsBit9(n, 0, 0, 0, 0);
    ...
    public static void dfsBit9(int n, int row, int col, int pie, int na){
        if (row >= n){
            count9++;
            return;
        }
        ...
        while (bit > 0){
            int p = bit & -bit;
            dfsBit9(n, row + 1, col | p, (pie | p) << 1, (na | p) >> 1);
            bit &= (bit - 1);
        }
    }
